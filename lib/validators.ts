...
export const FreightOrderSchema = z.object({
  ...
  buonny_status: z.enum(['Aprovado', 'Em Análise', 'Reprovado']).optional().default('Em Análise'),
  pancary_status: z.enum(['Aprovado', 'Em Análise', 'Reprovado']).optional().default('Em Análise'),
