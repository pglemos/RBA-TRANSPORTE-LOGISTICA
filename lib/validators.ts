...
export const DriverSchema = z.object({
  ...
  phone: z.string().optional().or(z.literal('')).refine(value => !value || isValidBrazilianPhone(value), "Telefone inválido"),
  bank_name: z.string().optional().or(z.literal('')),
  bank_agency: z.string().optional().or(z.literal('')),
  bank_account: z.string().optional().or(z.literal('')),
  pix_key: z.string().optional().or(z.literal('')).refine(value => !value || isValidPixKey(value), "Chave Pix inválida"),
  beneficiary_name: z.string().optional().or(z.literal('')),
  beneficiary_document: z.string().optional().or(z.literal('')).refine(value => !value || isValidCpfOrCnpj(value), "CPF/CNPJ do beneficiário inválido"),
...
export const FreightOrderSchema = z.object({
  ...
  balance_value: z.number().optional(),
