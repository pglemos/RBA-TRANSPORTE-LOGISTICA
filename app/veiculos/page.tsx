                ...
                <tbody className="divide-y divide-slate-100 font-semibold text-slate-700">
                  {filteredVehicles.map((v) => (
                    <tr key={v.id} className="hover:bg-slate-50">
                      ...
                      <td className="p-4">
                        <span className="font-bold border-2 border-slate-600 bg-slate-50 rounded p-1 px-2.5 text-slate-900 text-[11px]">
                          {v.tractor_plate}
                        </span>
                      </td>
                      <td className="p-4">
                        <span className="font-bold border-2 border-slate-400 bg-slate-50 rounded p-1 px-2.5 text-slate-600 text-[11px]">
                          {v.trailer_plate || 'Sem carreta'}
                        </span>
                      </td>
                      <td className="p-4 text-slate-600 font-bold">{v.antt || 'Isento'}</td>
                      <td className="p-4 text-slate-500">{v.renavam || 'N/A'}</td>
                      <td className="p-4">
                        <div className="text-[11px]">
                          <p>{v.owner_name}</p>
                          <p className="text-[9.5px] text-slate-500">ID: {v.owner_document}</p>
                        </div>
                      </td>
