...
CREATE TABLE IF NOT EXISTS public.freight_orders (
    ...
    buonny_status TEXT NOT NULL DEFAULT 'Renovar' CHECK (buonny_status IN ('Aprovado', 'Renovar')),
    buonny_code TEXT NOT NULL DEFAULT '' CHECK (char_length(buonny_code) <= 20),
    cte_number TEXT,
    cte_value NUMERIC(12, 2) NOT NULL DEFAULT 0.00,
    cte_discount_percent NUMERIC(5, 2) NOT NULL DEFAULT 10.00,
    ...
    emission_day TEXT NOT NULL DEFAULT '',
    emission_month TEXT NOT NULL DEFAULT '',
    emission_year TEXT NOT NULL DEFAULT '',
    responsible_name TEXT NOT NULL,
    buonny_responsible TEXT NOT NULL DEFAULT '',
    signature_url TEXT,
    status TEXT NOT NULL DEFAULT 'Rascunho' CHECK (status IN ('Rascunho', 'Em Análise', 'Aprovado', 'Liberado para Embarque', 'Carregando', 'Em Viagem', 'Entregue', 'Pago', 'Cancelado')),
    notes TEXT,
